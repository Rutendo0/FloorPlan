...
const threeBedroomDuplexPlans = [
  {
    id: 301,
    title: "Double Storey 3-Bedroom Duplex",
    ...
    bathrooms: 2,
    powderRooms: 1,
    features: ["Master bedroom with ensuite", "Open plan living", "Modern kitchen", "Dining area", "Parking space", "Ground floor powder room"],
    interiorImages: [
      { id: 3011, name: "Ground Floor Master", image: "https://images.unsplash.com/photo-1631049035382-9847d7b0b8b2?w=800&h=600&fit=crop" },
      { id: 3012, name: "Kitchen & Dining Hub", image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&h=600&fit=crop" },
      { id: 3013, name: "Family Living Space", image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop" },
      { id: 3014, name: "Double Garage & Entry", image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800&h=600&fit=crop" },
      { id: 3015, name: "Powder Room", image: "https://images.unsplash.com/photo-1620626011761-996317b8d101?w=800&h=600&fit=crop" },
      { id: 3016, name: "Master Ensuite", image: "https://images.unsplash.com/photo-1620626011761-996317b8d101?w=800&h=600&fit=crop" },
      { id: 3017, name: "Dining Area", image: "https://images.unsplash.com/photo-1577140917170-285929fb55b7?w=800&h=600&fit=crop" }
    ]
  },
  {
    id: 302,
    ...
    bathrooms: 1,
    powderRooms: 0,
    features: ["Two additional bedrooms", "Family bathroom", "Upper level living area", "Private balcony", "Built-in storage", "Study nook"],
    interiorImages: [
      { id: 3021, name: "Second Bedroom", image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop" },
      { id: 3022, name: "Third Bedroom", image: "https://images.unsplash.com/photo-1631049035382-9847d7b0b8b2?w=800&h=600&fit=crop" },
      { id: 3023, name: "Upper Level Living", image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop" },
      { id: 3024, name: "Private Balcony", image: "https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=800&h=600&fit=crop" },
      { id: 3025, name: "Family Bathroom", image: "https://images.unsplash.com/photo-1620626011761-996317b8d101?w=800&h=600&fit=crop" },
      { id: 3026, name: "Study Nook", image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop" },
      { id: 3027, name: "Built-in Storage", image: "https://images.unsplash.com/photo-1503174971373-b1f69850bded?w=800&h=600&fit=crop" }
    ]
  }
]

export default function ThreeBedroomDuplexDoubleStoreyPage() {
          ...
          <Link href="/floorplans/double-storey" className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-stone-500 uppercase tracking-wider hidden sm:block">
                3-Bedroom Double Storey Duplex
              </p>
            </div>
          </Link>
