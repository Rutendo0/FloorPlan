    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 lg:py-12">
        {!selectedPlan ? (
          <div>
            <div className="text-center mb-12 lg:mb-16">
              ...
              <p className="text-lg text-gray-600 font-light max-w-2xl mx-auto leading-relaxed">
                Spacious duplex designs perfect for modern families seeking comfort and elegance
              </p>
            </div>
          ...
          // Detail View - Same as your existing detail view but with updated styling
          <div>
            ...
            {/* Interior Images Slideshow Section - Same as existing */}
