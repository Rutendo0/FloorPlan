...
const fourBedroomPlans = [
  {
    ...
    features: [
      ...
      "Scullery for additional storage",
    ...
    interiorImages: [
      ...
      { src: "/images/image3.jpg", title: "Kitchen", description: "Contemporary kitchen with island bench" },
      { src: "/images/image2.jpg", title: "Master Bedroom", description: "Spacious master suite with walk-in robe" }
    ]
  },
  {
    id: 2,
    ...
    interiorImages: [
      ...
      { src: "/images/image2.jpg", title: "Family Room", description: "Comfortable family living area" },
      { src: "/images/image3.jpg", title: "Bedroom", description: "Well-appointed secondary bedroom" }
    ]
  },
  {
    id: 3,
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col lg:flex-row">
      ...
      <div className="lg:w-2/5 bg-stone-50 p-6 lg:p-8 flex flex-col relative">
        {/* Header */}
        <div className="mb-8">
          <Link href="/floorplans/single-storey" className="flex items-center space-x-2 group">
